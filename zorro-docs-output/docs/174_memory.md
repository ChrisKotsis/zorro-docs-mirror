...
   **3**: Current number of static and dynamic [series](091_series.md).  
...
*   The [LEAN](018_TradeMode.md) and [LEANER](018_TradeMode.md) flags reduce the memory requirement by about 50%, the **TICKS** flag increases it by 32 bytes per historical price tick. [Series](091_series.md) allocate 8 bytes per element, [plot](146_plot_plotBar.md) commands allocate 8..24 bytes per bar and asset.
