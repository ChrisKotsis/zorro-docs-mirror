...
*   Variables that affect bar creation and training, such as bar period, WFO settings, lookback period, and start/end dates, can only be changed for the whole strategy, but not for single jobs.
