...
*   In test and training, **contractUpdate** should be called once per bar for updating the prices. If contracts are purchased or contract prices are evaluated in a [tick](089_tick_tock.md) function or a [TMF](018_TradeMode.md), make sure to call **contractUpdate** before for using recent prices.
